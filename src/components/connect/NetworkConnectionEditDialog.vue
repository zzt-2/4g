...
<template>
    <q-dialog :model-value="modelValue" @update:model-value="$emit('update:modelValue', $event)" persistent>
            ...
            <q-card-section class="q-pa-md">
                <q-form ref="formRef" class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <q-select v-model="formData.type" :options="connectionTypes" outlined dense emit-value
                            map-options dark class="bg-industrial-secondary border-industrial text-industrial-primary"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div class="col-span-1">
                                <q-input v-model.number="formData.port" outlined dense type="number" :rules="portRules"
                                    placeholder="端口"
                                    class="bg-industrial-secondary border-industrial text-industrial-primary"
                                    input-class="text-industrial-primary" />
                            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <q-input v-model="formData.description" outlined dense type="textarea" rows="2"
                            placeholder="连接描述信息"
                            class="bg-industrial-secondary border-industrial text-industrial-primary"
                            input-class="text-industrial-primary" />
                    </div>
                    ...
                    <div v-if="formData.type === 'udp'" class="space-y-3 mt-6">
                        <div class="flex items-center justify-between pb-2 border-b border-industrial">
                            ...
                            <q-btn flat dense size="sm" icon="add" label="添加"
                                class="btn-industrial-primary text-xs px-3 py-1" @click="addRemoteHost" />
                        </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div v-if="host.description"
                                            class="text-xs text-industrial-tertiary mt-1 truncate">
                                            {{ host.description }}
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-1 ml-3">
                                        ...
                                        <q-btn flat dense size="xs" icon="edit"
                                            class="text-industrial-accent hover:bg-industrial-highlight p-1"
                                            @click="editRemoteHost(host)" />
                                        <q-btn flat dense size="xs" icon="delete"
                                            class="text-red-400 hover:bg-industrial-highlight p-1"
        ...
        <!-- 远程主机编辑对话框 -->
        <q-dialog v-model="remoteHostDialog" persistent>
            <q-card class="bg-industrial-panel border border-industrial w-[400px] max-w-[90vw]">
                ...
                <q-card-section class="q-pa-md">
                    <q-form ref="remoteHostFormRef" class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <q-input v-model="remoteHostForm.name" outlined dense :rules="remoteHostNameRules"
                                placeholder="输入主机名称"
                                class="bg-industrial-secondary border-industrial text-industrial-primary"
                                input-class="text-industrial-primary" />
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="col-span-2">
                                    <q-input v-model="remoteHostForm.host" outlined dense :rules="hostRules"
                                        placeholder="IP地址或域名"
                                        class="bg-industrial-secondary border-industrial text-industrial-primary"
                                        input-class="text-industrial-primary" />
                                </div>
                                <div class="col-span-1">
                                    <q-input v-model.number="remoteHostForm.port" outlined dense type="number"
                                        :rules="portRules" placeholder="端口"
                                        class="bg-industrial-secondary border-industrial text-industrial-primary"
                                        input-class="text-industrial-primary" />
                                </div>
                            </div>
                        ...
                        <div class="space-y-2">
                            <label class="text-sm font-medium text-industrial-primary">描述 (可选)</label>
                            <q-input v-model="remoteHostForm.description" outlined dense type="textarea" rows="2"
                                placeholder="远程主机描述"
                                class="bg-industrial-secondary border-industrial text-industrial-primary"
                                input-class="text-industrial-primary" />
                        </div>
                ...
                <q-card-actions
                    ...
                    <q-btn flat label="取消" class="btn-industrial-secondary px-4 py-2"
                        @click="remoteHostDialog = false" />
