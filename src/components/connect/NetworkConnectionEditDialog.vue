    ...
    <q-card class="bg-industrial-panel border border-industrial w-[450px] max-w-[90vw]">
          ...
          <div class="space-y-3 mt-6">
            <div class="flex items-center justify-between pb-2 border-b border-industrial">
              ...
              <q-btn
                ...
                icon="add"
                label="添加"
                class="btn-industrial-primary text-xs px-3 py-1"
                @click="addRemoteHost"
              />
            </div>
            ...
            <!-- 远程主机列表 -->
            <div
              v-if="formData.remoteHosts && formData.remoteHosts.length > 0"
              class="space-y-2 max-h-60 overflow-y-auto"
            >
              <div
                v-for="host in formData.remoteHosts"
                :key="host.id"
              ...
              >
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-1 ml-3">
                    <q-toggle
                      :model-value="host.enabled !== false"
                      size="xs"
                      color="green"
      ...
      >
        ...
        <q-btn
          ...
          class="btn-industrial-primary px-4 py-2"
          @click="handleSave"
        />
      </q-card-actions>
    </q-card>
        ...
        <q-card-section class="q-pa-md">
          <q-form ref="remoteHostFormRef" class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <q-input
                v-model="remoteHostForm.name"
                outlined
                dense
                :rules="remoteHostNameRules"
                placeholder="输入主机名称"
                class="bg-industrial-secondary border-industrial text-industrial-primary"
                input-class="text-industrial-primary"
              />
            ...
            <div class="space-y-2">
              ...
              <div class="grid grid-cols-3 gap-3">
                ...
                <div class="col-span-1">
                  <q-input
                    v-model.number="remoteHostForm.port"
                    outlined
                    dense
                    type="number"
                    :rules="portRules"
            ...
            <div class="flex items-center">
              <q-toggle
                v-model="remoteHostForm.enabled"
                label="启用此远程主机"
                color="green"
            ...
            <div class="space-y-2">
              <label class="text-sm font-medium text-industrial-primary">描述 (可选)</label>
              <q-input
                v-model="remoteHostForm.description"
                outlined
                dense
                type="textarea"
                rows="2"
