    ...
    <div class="relative bg-industrial-secondary">
      <div class="flex flex-shrink-0 no-wrap items-center gap-6 p-4">
        <div class="flex items-center gap-2">
          <!-- SCOE标识 -->
          <div class="flex items-center gap-2">
            <label class="w-16 text-industrial-secondary text-sm whitespace-nowrap"
              >SCOE标识:</label
            >
            <q-input
              v-model="scoeStore.globalConfig.scoeIdentifier"
              class="w-16"
              dense
              outlined
          ...
          <div class="flex items-center gap-2">
            ...
            <q-input
              v-model="localSatelliteConfig.satelliteId"
              class="w-24"
              dense
              outlined
              bg-color="industrial-secondary"
        ...
        <div class="flex-1 max-w-130 flex items-center gap-2 ml-auto">
          ...
          <q-btn
            class="flex-1"
            size="sm"
            :color="scoeStore.tcpConnected ? 'negative' : 'primary'"
          ...
          >
            <q-icon
              :name="scoeStore.status.scoeFramesLoaded ? 'file_upload' : 'file_download'"
              class="mr-1"
            />
            {{ scoeStore.status.scoeFramesLoaded ? '卸载' : '加载' }}
          </q-btn>
          <q-btn
            class="btn-industrial-primary flex-1"
            size="sm"
            :disable="!scoeStore.selectedConfig"
            @click="handleSave"
          >
          ...
          <q-btn
            class="btn-industrial-secondary flex-1"
            size="sm"
            :disable="!scoeStore.selectedConfig"
      ...
      <div
        v-if="showConfigForm"
        class="absolute -bottom-56 w-full z-100 flex flex-col items-start p-3 gap-3 border-3 border-solid border-industrial bg-industrial-secondary"
      >
        <div class="flex no-wrap items-center gap-6">
          <!-- TCP Server IP -->
          <div class="flex items-center gap-2 w-64">
            <label class="flex-1 text-industrial-secondary text-sm whitespace-nowrap"
              >TCP Server IP地址:</label
            >
            <q-input
              v-model="scoeStore.globalConfig.tcpServerIp"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            <q-input
              v-model="scoeStore.globalConfig.tcpServerPort"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            <q-toggle
              v-model="scoeStore.globalConfig.tcpServerAutoConnect"
              color="green"
              size="sm"
            />
        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model="scoeStore.globalConfig.udpIpAddress"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model="scoeStore.globalConfig.udpPort"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.messageIdentifierOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.sourceIdentifierOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.destinationIdentifierOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.modelIdOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.satelliteIdOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
          ...
          <div class="flex items-center gap-2 w-64">
            ...
            >
            <q-input
              v-model.number="scoeStore.globalConfig.functionCodeOffset"
              class="w-32"
              dense
              outlined
              bg-color="industrial-secondary"
        ...
        <div class="w-full flex gap-4">
          ...
          <div class="flex-1 bg-industrial-secondary border border-industrial rounded p-4">
            <div class="flex no-wrap items-start justify-between">
              <h4
                class="text-industrial-primary text-base font-medium pb-3 mt-2 flex items-center no-wrap"
              >
              ...
              <div class="flex no-wrap">
                <q-checkbox
                  v-model="localSatelliteConfig.receiveConfig.recognitionMessageId"
                  label="信息"
                />
                <q-checkbox
                  v-model="localSatelliteConfig.receiveConfig.recognitionSourceId"
                  label="信源"
                />
                <q-checkbox
                  v-model="localSatelliteConfig.receiveConfig.recognitionDestinationId"
                  label="信宿"
                />
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div v-for="(field, index) in receiveConfigFields" :key="field.key">
                <label
                  class="block text-industrial-secondary text-sm mb-1"
                  :class="{ 'text-red-5': receiveConfigValidationErrors[index] }"
                  >{{ field.label }}</label
                >
                <q-input
                  v-model="(localSatelliteConfig.receiveConfig as any)[field.key]"
          ...
          <div class="flex-1 bg-industrial-secondary border border-industrial rounded p-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div v-for="(field, index) in sendConfigFields" :key="field.key">
                <label
                  class="block text-industrial-secondary text-sm mb-1"
                  :class="{ 'text-red-5': sendConfigValidationErrors[index] }"
                  >{{ field.label }}</label
                >
                <q-input
                  v-model="(localSatelliteConfig.sendConfig as any)[field.key]"
                  :placeholder="field.placeholder"
                  dense
                  outlined
                  bg-color="industrial-panel"
