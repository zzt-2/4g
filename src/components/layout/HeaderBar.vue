  ...
  <q-header class="bg-[#1e293b] shadow-sm" style="-webkit-app-region: drag">
    <q-toolbar class="h-[48px]">
      <div class="flex items-center" style="-webkit-app-region: no-drag">
        <div
          class="flex items-center justify-center h-[32px] w-[32px] bg-[#0f172a] rounded-md mr-3"
        >
      ...
      <div class="flex items-center" style="-webkit-app-region: no-drag">
        <q-btn
          ...
          dense
          round
          class="w-[36px] h-[36px] text-[#94a3b8] hover:bg-[#334155]"
        ...
        <q-btn
          ...
          dense
          round
          class="w-[36px] h-[36px] text-[#94a3b8] hover:bg-[#dc2626] hover:text-white"
