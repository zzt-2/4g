      ...
      <q-card-section class="space-y-4" style="max-height: 70vh; overflow-y: auto">
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <!-- 关联数据项 -->
            <q-select
              :model-value="getDataItemDisplayValue(indicator)"
              :options="availableDataItemOptions"
              label="关联数据项"
              emit-value
              map-options
              outlined
            ...
            <div>
              ...
              <div class="flex items-center space-x-3">
                <input
                  v-model="indicator.defaultColor"
                  type="color"
            ...
            <div>
              <div class="flex items-center justify-between mb-3">
                ...
                <q-btn
                  ...
                  size="sm"
                  color="blue"
                  @click="addMappingValue(indicator)"
                />
              </div>

              <div class="space-y-3">
                <div
                  v-for="(mapping, mappingIndex) in indicator.valueMappings"
                  :key="mappingIndex"
                ...
                >
                  ...
                  <div class="flex-1">
                    <q-select
                      v-if="shouldUseSelect(indicator)"
                      v-model="mapping.value"
                      :options="getLabelOptions(indicator)"
                      emit-value
                      map-options
                      outlined
                      dense
                    ...
                    <q-input
                      ...
                      bg-color="industrial-secondary"
                      color="blue"
                      placeholder="输入值或范围(如: 10-20)"
                      :hint="getCurrentValueHint(indicator)"
                    />
                  </div>
